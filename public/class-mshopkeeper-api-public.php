 ...
 * @subpackage Mshopkeeper_Api/public
 */
...
class Mshopkeeper_Api_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/mshopkeeper-api-public.css', array(), $this->version, 'all' );
